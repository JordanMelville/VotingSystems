...
public static void main(String[] args) throws IOException{
	...
	System.out.println();
	System.out.println("DhondtElection1.txt");
	System.out.println("DhondtElection2.txt");
	System.out.println("DhondtElection3.txt");
	System.out.println("DhondtElection4.txt");
	System.out.println();
	...
	while(true) {
		...
		if(command.equals("Help")) {
			...
			System.out.println("BLUE Votes 290 Seats 19");
			System.out.println("GREEN Votes 190 Seats 11");
			System.out.println("YELLOW Votes 150 Seats 9");
			System.out.println();
			System.out.println("This represents 370 votes and 24 seats for RED, 290 votes and 19 seats for BLUE, 190 votes and 11 seats for GREEN and 150 votes and 9 seats for YELLOW.");
			System.out.println();
